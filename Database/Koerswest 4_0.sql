...
-- -----------------------------------------------------
-- Table `koersWest`.`afbeelding`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `koersWest`.`afbeelding` (
  `Afbeelding` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`Afbeelding`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `koersWest`.`categorie` (
  ...
  `afbeelding_Afbeelding` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`Categorie`),
  INDEX `fk_categorie_afbeelding1_idx` (`afbeelding_Afbeelding` ASC),
  CONSTRAINT `fk_categorie_afbeelding1`
    FOREIGN KEY (`afbeelding_Afbeelding`)
    REFERENCES `koersWest`.`afbeelding` (`Afbeelding`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
