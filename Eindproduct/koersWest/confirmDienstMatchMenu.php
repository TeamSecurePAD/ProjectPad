    ...
    <div class = "container">
      ...
      <div class = "body col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div class = "title">
          ...
          <div class = "tile_info">
            <h1><c class = "white">Netwerk Diensten</c></h1>
            <h2><c class = "white">Hieronder staan contact gegevens van mensen die tegenovergestelde diensten aanbieden en vragen.
                                   Je kan nu zelf contact opnemen.</c></h2>
          </div>
        </div>
