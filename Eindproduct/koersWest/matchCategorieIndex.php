...
<html lang="en">
  <head>
    ...
    <title>Match Categorie Index</title>
  </head>
      ...
      <div class = "body col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div class = "title">
          ...
          <div class = "tile purple">
            ...
            <h2>Selecteer of je matches wilt accepteren of naar je contacten wilt.</h2>
          </div>
        </div>
        ...
        <div class = "subbody">
            ...
            <div class = "block_divider col-xs-12 col-sm-6 col-md-4 col-lg-4">
              <div class = "block purple regular">
                ...
                <div class = "media-body">
                  <h3 class = "media-heading"><b>Matches keuren</b></h3>
                ...
                <div class = "service_button">
                  <form action = "matchCategorieKeuren.php">
            ...
            <div class = "block_divider col-xs-12 col-sm-6 col-md-4 col-lg-4">
              <div class = "block purple regular">
                ...
                <!-- Block text -->
                <div class = "media-body">
                  <h3 class = "media-heading"><b>Categorie contacten</b></h3>
                  <img class = "image" src = "images/contacts.png" width = "150" height = "150"><br>
                </div>

                <!-- Submit button -->
                <div class = "service_button">
                  <form action = "matchCategorieContacten.php">
