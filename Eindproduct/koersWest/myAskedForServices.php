      ...
      <div class = "body col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div class = "title">
          ...
          <div class = "tile_profile">
            <h1><c class = "white">Gevraagde diensten</c></h1>
            ...
            {
              ?>
              <h2><c class = "white">Om deze diensten vraagt u.</c></h2>
              <?php
            }
            ?>
          </div>
                  ...
                  <div class = "block col-xs-12 col-sm-6 col-md-4 col-lg-3">
                    <div class = "block_ask_for_service">
                      ...
                      <div class = "media-body">
                        ...
                        <h3 class = "media-heading" style = "position: absolute; bottom: 15px; left: 20%; right: 20%;"><b class = "white">U vraagt om deze dienst.</b></h3>
                      </div>
            ...
            if ($geselecteerde_categorie != "NONE" && !$any_services)
            {
              ...
              <div class = "block col-xs-12 col-sm-6 col-md-4 col-lg-3">
                <div class = "block_ask_for_service">
                  ...
                  <!-- Block text -->
                  <div class = "media-body">
                    <h3 class = "media-heading"><b class = "white">Geen diensten gevraagd</b></h3>
                    <img class = "image" src = "images/warning.png" width = "110" height = "110"><br><br>
                    <h3 class = "media-heading"><b class = "white">U vraagt voor geen enkele dienst uit deze categorie om hulp.</b></h3>
                  </div>
            ...
            <div class = "block col-xs-12 col-sm-6 col-md-4 col-lg-3">
              <div class = "block_grey">
                ...
                <div class = "service_button">
                  <form action = "myAskedForServices.php">
                    <button type = "submit" class = "btn btn-secondary" style = "color: black;">Klik hier om terug te gaan</button>
                  </form>
                </div>
