      ...
      <div class = "body col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div class = "title">
          ...
          <div class = "tile_offer_service">
            ...
            {
              ?>
              <h1><c class = "white">Competentie</c></h1>
            ...
            else
            {
              ...
              <h1><c class = "white">Competentie</c></h1>
              <img class = "image" src = "images/thumbsup.png" width = "86" height = "86">
              <h2><c class = "white">De categorie waar u goed in bent.</c></h2>
              <?php
            }
            ?>
          </div>
                ...
                <div class = "block col-xs-12 col-sm-6 col-md-4 col-lg-3">
                  <div class = "block_success_small">
                    ...
                    <div class = "media-body">
                      ...
                      <h3 class = "media-heading" style = "margin-bottom: 0px;"><b class = "white">Dit is uw huidige competentie.</b></h3>
                    </div>
